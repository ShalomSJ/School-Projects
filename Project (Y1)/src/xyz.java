System.out.println("---------------------------Welcome All-------------------\n------------------- Create Your Own Playlist---------------");
        ...
        LinkedList songs=new LinkedList();//Song is a class which has three fields song name,artist name and duration of the song
        boolean first=true;
        while(first){
        ...
        ListIterator j=songs.listIterator();//This is iterator and helps us to iterate to a linked list.
